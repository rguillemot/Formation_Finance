...
\hline
\textcolor{red}{\textbf{EUR}}&\hide{1-2}{\textcolor<3->{red}{$\frac{(N^{EUR} \times S^{EUR/USD}-N^{USD})_+}{S^{EUR/USD}}$}}&\hide{1-3}{\textcolor<4->{red}{$(N^{EUR}-N^{USD} \times S^{USD/EUR})_+$}} \\
\textcolor{blue}{\textbf{USD}}& \hide{1}{\textcolor<2->{blue}{$(N^{EUR} \times S^{EUR/USD}-N^{USD})_+$}} & \hide{1-4}{\textcolor<5->{blue}{$\frac{(N^{EUR}-N^{USD} \times S^{USD/EUR})_+}{S^{USD/EUR}}$}}\\
\hline
\end{tabular}
\begin{center}
