...
\begin{tabular}{|c|c|c|c|} 
\hline 
$\mathbf{K^{10Put}}$&1.1201&$\mathbf{\sigma^{10Put}}$&18.0\%\\
$\mathbf{K^{25Put}}$&1.2755&$\mathbf{\sigma^{25Put}}$&14.0\%\\
$\mathbf{K^{ATM}}$&1.3975&$\mathbf{\sigma^{ATM}}$&12.0\%\\
$\mathbf{K^{25Call}}$&1.5148&$\mathbf{\sigma^{25Call}}$&12.0\%\\
$\mathbf{K^{10Call}}$&1.6760&$\mathbf{\sigma^{10Call}}$&14.0\%\\
\hline 
\end{tabular}
\end{center} 
\end{frame}
