...
\hline
\hline
\textbf{PNL EUR} &35&9&43&kEUR\\
\textbf{PNL USD} &48&12&60&kUSD\\
\hline
\hline
\textbf{Delta FX} &-99.60&71.79&-27.81&Mios EUR\\
\textbf{Sensi taux} &9.92&-7.15&2.77&kEUR/bp\\
\textbf{Sensi taux} &-13.80&9.94&-3.86&kUSD/bp\\
\textbf{Sensi basis} &-9.92&7.15&-2.77&kEUR/bp\\
\hline
\hline
...
\begin{align*}
\bm{\delta}=\frac{\partial p}{\partial S}=e^{-r^{1} \times T} \mathcal{N}(d_1)& \text{\textbf{Vega}}=\frac{\partial p}{\partial \sigma}=e^{-r^{1} \times T}S\sqrt{T}\mathcal{N'}(d_1)
\end{align*}
\[
