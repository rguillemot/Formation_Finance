...
\end{center}
\[
\uncover<7->{X=} \uncover<8->{1.0878\times \frac{1+\frac{365}{360} \times 0.01\%}{1+\frac{365}{360} \times 0.45\%}\uncover<9->{=1.09264}} 
\]
...
Prix en dollars pips per EUR&\visible<6->{$\frac{p}{N \times 1e^4}$}& \visible<6->{548.85 USD pips}\\
Prix en euros pips per USD&\visible<7->{$\frac{p}{S \times N \times K \times 1e^4}$}& \visible<7->{462.87 EUR pips}\\
\hline
\end{tabular}
\end{frame}
