...
\begin{itemize}
\item<3-4>\textbf{"en dessous de pair"}: $P<100$ et $R>C$.
\item<4>\textbf{"au dessus de pair"}: $P>100$ et $R<C$.
\end{itemize}
\onslide<5-7>Un opérateur est:
\begin{itemize}
\item<6-7>\textcolor{red}{\textbf{"Long"}} sous entendu de l'obligation: il anticipe une \textcolor{red}{\textbf{baisse}} des taux.
\item<7>\textcolor{blue}{\textbf{"Short"}} sous entendu de l'obligation: il anticipe une \textcolor{blue}{\textbf{hausse}} des taux.
\end{itemize}
\end{overprint}
\begin{center}
\begin{figure}
...
\end{figure}
\end{center}
Les différents format du taux zéro coupon $R$:\\
\begin{center}
...
P = 1
\]
\textbf{La valeur d'une obligation à taux variable (sans marge) est insensible au taux (les jours de paiement de ses coupons).}
\end{overprint}
\end{frame}
